...
const Dashboard = () => {
  ...
  return (
    <div className="w-full pt-16 px-4 pb-8">
      ...
      <div className="border-2 border-red-100 w-11/12 m-auto rounded-lg p-4">
        {chartData.datasets ? (
          <Line data={chartData} />
        ) : (
      ...
      <h1 className="text-4xl font-bold mb-4 mt-8 text-blue-500">
        Corona Cases World Map
      </h1>
      <div className="border-2 border-blue-500 w-11/12 m-auto rounded-lg p-4">
        <MapContainer
          className="w-full rounded-lg border-blue-700"
          bounds={[
            [-60, -180],
            [85, 180],
          ]}
